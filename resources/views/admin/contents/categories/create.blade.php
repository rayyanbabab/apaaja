    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-medium text-gray-900 flex items-center">
                ...
                Tips Membuat Kategori yang Efektif
            </h3>
        </div>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <h4 class="text-sm font-medium text-gray-900">Nama yang Jelas</h4>
                        <p class="text-sm text-gray-600">Gunakan nama yang mudah dipahami pengguna</p>
                    </div>
                </div>
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <h4 class="text-sm font-medium text-gray-900">Deskripsi Informatif</h4>
                        <p class="text-sm text-gray-600">Jaga deskripsi ringkas namun informatif</p>
                    </div>
                </div>
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <h4 class="text-sm font-medium text-gray-900">Organisasi Inventori</h4>
                        <p class="text-sm text-gray-600">Pertimbangkan bagaimana kategori membantu mengorganisir inventori</p>
                    </div>
                </div>
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <h4 class="text-sm font-medium text-gray-900">Mulai dari Luas</h4>
                        <p class="text-sm text-gray-600">Mulai dengan kategori luas dan tambahkan subkategori nanti</p>
                    </div>
                </div>
            </div>
        </div>
