...
<div class="desktop-sidebar hidden md:flex md:flex-shrink-0 md:w-64" x-data="sidebarData()" x-init="init()">
    <div class="sidebar-container w-64 bg-white fixed top-0 left-0 z-40 border-r border-gray-100 flex flex-col h-full shadow-sm">
        ...
        {{-- ═══════════════ OPERATOR NAV (Maintenance Only) ═══════════════ --}}
            ...
            <a href="{{ route($routePrefix . '.dashboard') }}"
               class="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg transition-all duration-150
                ...
                <svg style="width:18px;height:18px;flex-shrink:0;" class="{{ Route::is($routePrefix . '.dashboard') ? $ic6 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <a href="{{ route('scanner.index') }}"
               class="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg transition-all duration-150
                ...
                <svg style="width:18px;height:18px;flex-shrink:0;" class="{{ Route::is('scanner.*') ? $ic6 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <a href="{{ route($routePrefix . '.maintenance.index') }}"
                   class="flex items-center justify-between px-3 py-2 text-sm font-medium rounded-lg transition-all duration-150
                    ...
                    <div class="flex items-center gap-3">
                        <svg style="width:18px;height:18px;flex-shrink:0;" class="{{ Route::is($routePrefix . '.maintenance.*') ? $ic6 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    @php $opInRepair = \App\Models\Maintenance::where('status', 'in_repair')->count(); @endphp
                    @if($opInRepair > 0)
                        <span class="inline-flex items-center justify-center w-5 h-5 text-[10px] font-bold text-white bg-orange-500 rounded-full flex-shrink-0 animate-pulse">{{ $opInRepair }}</span>
                    @endif
                </a>
            </div>
            ...
            <div class="pt-4 flex flex-col gap-1">
                ...
                <a href="{{ route($routePrefix . '.profile.index') }}"
                   class="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg transition-all duration-150
                          {{ Route::is($routePrefix . '.profile.*') ? $navActive : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                    <svg style="width:18px;height:18px;flex-shrink:0;" class="{{ Route::is($routePrefix . '.profile.*') ? $ic6 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <a href="{{ route($routePrefix . '.notifications.index') }}"
                   class="flex items-center justify-between px-3 py-2 text-sm font-medium rounded-lg transition-all duration-150
                    ...
                    <div class="flex items-center gap-3">
                        <svg style="width:18px;height:18px;flex-shrink:0;" class="{{ Route::is($routePrefix . '.notifications.*') ? $ic6 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        {{-- ═══════════════ ADMIN NAV (Full Menu) ═══════════════ --}}
            ...
            <div class="pt-4 flex flex-col gap-1">
                ...
                <button @click="masterDataOpen = !masterDataOpen"
                    ...
                    <div class="flex items-center gap-3">
                        <svg style="width:18px;height:18px;flex-shrink:0;" :class="masterDataOpen ? '{{ $ic6 }}' : 'text-gray-400'" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <svg style="width:14px;height:14px;flex-shrink:0;" class="transform transition-transform duration-200"
                ...
                <div x-show="masterDataOpen" x-collapse class="mt-1 space-y-0.5 pl-7">
                    <a href="{{ route($routePrefix . '.categories.index') }}"
                       class="flex items-center gap-2.5 px-3 py-2 text-sm rounded-lg transition-all duration-150
                        ...
                        <svg style="width:15px;height:15px;" class="{{ Route::is($routePrefix . '.categories.*') ? $ic5 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="{{ route($routePrefix . '.suppliers.index') }}"
                       class="flex items-center gap-2.5 px-3 py-2 text-sm rounded-lg transition-all duration-150
                        ...
                        <svg style="width:15px;height:15px;" class="{{ Route::is($routePrefix . '.suppliers.*') ? $ic5 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="{{ route($routePrefix . '.locations.index') }}"
                       class="flex items-center gap-2.5 px-3 py-2 text-sm rounded-lg transition-all duration-150
                        ...
                        <svg style="width:15px;height:15px;" class="{{ Route::is($routePrefix . '.locations.*') ? $ic5 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="pt-4 flex flex-col gap-1">
                ...
                <button @click="inventoryOpen = !inventoryOpen"
                    ...
                    <div class="flex items-center gap-3">
                        <svg style="width:18px;height:18px;flex-shrink:0;" :class="inventoryOpen ? '{{ $ic6 }}' : 'text-gray-400'" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div x-show="inventoryOpen" x-collapse class="mt-1 space-y-0.5 pl-7">
                    <a href="{{ route($routePrefix . '.inventory.index') }}"
                       class="flex items-center gap-2.5 px-3 py-2 text-sm rounded-lg transition-all duration-150
                        ...
                        <svg style="width:15px;height:15px;" class="{{ Route::is($routePrefix . '.inventory.*') ? $ic5 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="{{ route($routePrefix . '.incoming.index') }}"
                       class="flex items-center gap-2.5 px-3 py-2 text-sm rounded-lg transition-all duration-150
                        ...
                        <svg style="width:15px;height:15px;" class="{{ Route::is($routePrefix . '.incoming.*') ? $ic5 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="{{ route($routePrefix . '.outgoing.index') }}"
                       class="flex items-center gap-2.5 px-3 py-2 text-sm rounded-lg transition-all duration-150
                        ...
                        <svg style="width:15px;height:15px;" class="{{ Route::is($routePrefix . '.outgoing.*') ? $ic5 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="{{ route($routePrefix . '.maintenance.index') }}"
                       class="flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-all duration-150
                        ...
                        <div class="flex items-center gap-2.5">
                            <svg style="width:15px;height:15px;" class="{{ Route::is($routePrefix . '.maintenance.*') ? $ic5 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                            </svg>
                            Maintenance
                        ...
                        @if($inRepairCount > 0)
                            <span class="inline-flex items-center justify-center w-5 h-5 text-[10px] font-bold text-white bg-orange-500 rounded-full flex-shrink-0">{{ $inRepairCount }}</span>
                        @endif
                    </a>
                    <a href="{{ route($routePrefix . '.stock-opnames.index') }}"
                       class="flex items-center gap-2.5 px-3 py-2 text-sm rounded-lg transition-all duration-150
                        ...
                        <svg style="width:15px;height:15px;" class="{{ Route::is($routePrefix . '.stock-opnames.*') ? $ic5 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="pt-4 flex flex-col gap-1">
                ...
                <button @click="borrowingOpen = !borrowingOpen"
                    ...
                    <div class="flex items-center gap-3">
                        <svg style="width:18px;height:18px;flex-shrink:0;" :class="borrowingOpen ? '{{ $ic6 }}' : 'text-gray-400'" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div x-show="borrowingOpen" x-collapse class="mt-1 space-y-0.5 pl-7">
                    <a href="{{ route($routePrefix . '.borrowings.index') }}"
                       class="flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-all duration-150
                        ...
                        <div class="flex items-center gap-2.5">
                            <svg style="width:15px;height:15px;" class="{{ Route::is($routePrefix . '.borrowings.index') ? $ic5 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                            </svg>
                            Item Borrowing
                        </div>
                    ...
                    <a href="{{ route($routePrefix . '.borrowing-requests.index') }}"
                       class="flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-all duration-150
                        ...
                        <div class="flex items-center gap-2.5">
                            <svg style="width:15px;height:15px;" class="{{ Route::is($routePrefix . '.borrowing-requests.*') && !Route::is($routePrefix . '.borrowing-requests.history') ? $ic5 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="{{ route($routePrefix . '.borrowing-requests.history') }}"
                       class="flex items-center gap-2.5 px-3 py-2 text-sm rounded-lg transition-all duration-150
                              {{ Route::is($routePrefix . '.borrowing-requests.history') ? $navActiveM : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <svg style="width:15px;height:15px;" class="{{ Route::is($routePrefix . '.borrowing-requests.history') ? $ic5 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        Approval History
                    </a>
                    <a href="{{ route($routePrefix . '.borrowings.history') }}"
                       class="flex items-center gap-2.5 px-3 py-2 text-sm rounded-lg transition-all duration-150
                              {{ Route::is($routePrefix . '.borrowings.history') ? $navActiveM : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <svg style="width:15px;height:15px;" class="{{ Route::is($routePrefix . '.borrowings.history') ? $ic5 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        Borrowing History
                    </a>
            ...
            <div class="pt-4 flex flex-col gap-1">
                ...
                <a href="{{ route($routePrefix . '.procurement-requests.index') }}"
                   class="flex items-center justify-between px-3 py-2 text-sm font-medium rounded-lg transition-all duration-150
                    ...
                    <div class="flex items-center gap-3">
                        <svg style="width:18px;height:18px;flex-shrink:0;" class="{{ Route::is($routePrefix . '.procurement-requests.*') ? $ic6 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="pt-4 flex flex-col gap-1">
                ...
                <button @click="usersOpen = !usersOpen"
                    ...
                    <div class="flex items-center gap-3">
                        <svg style="width:18px;height:18px;flex-shrink:0;" :class="usersOpen ? '{{ $ic6 }}' : 'text-gray-400'" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div x-show="usersOpen" x-collapse class="mt-1 space-y-0.5 pl-7">
                    <a href="{{ route($routePrefix . '.content.listusers') }}"
                       class="flex items-center gap-2.5 px-3 py-2 text-sm rounded-lg transition-all duration-150
                        ...
                        <svg style="width:15px;height:15px;" class="{{ Route::is($routePrefix . '.content.listusers') ? $ic5 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="{{ route($routePrefix . '.content.createusers') }}"
                       class="flex items-center gap-2.5 px-3 py-2 text-sm rounded-lg transition-all duration-150
                        ...
                        <svg style="width:15px;height:15px;" class="{{ Route::is($routePrefix . '.content.createusers') ? $ic5 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="pt-4 flex flex-col gap-1">
                ...
                <a href="{{ route($routePrefix . '.reports.index') }}"
                   class="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg transition-all duration-150
                    ...
                    <svg style="width:18px;height:18px;flex-shrink:0;" class="{{ Route::is($routePrefix . '.reports.*') ? $ic6 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <a href="{{ route($routePrefix . '.insights.index') }}"
                   class="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg transition-all duration-150
                    ...
                    <svg style="width:18px;height:18px;flex-shrink:0;" class="{{ Route::is($routePrefix . '.insights.*') ? $ic6 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <a href="{{ route($routePrefix . '.activities.index') }}"
                   class="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg transition-all duration-150
                    ...
                    <svg style="width:18px;height:18px;flex-shrink:0;" class="{{ Route::is($routePrefix . '.activities.*') ? $ic6 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                ...
                <a href="{{ route($routePrefix . '.settings.index') }}"
                   class="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg transition-all duration-150
                    ...
                    <svg style="width:18px;height:18px;flex-shrink:0;" class="{{ Route::is($routePrefix . '.settings.*') ? $ic6 : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/>
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                    </svg>
                    <span>Settings</span>
        ...
        <div class="flex-shrink-0 p-3 border-t border-gray-100">
            <form method="POST" action="{{ route('logout') }}">
                ...
                <button type="submit"
                    ...
                    <svg style="width:16px;height:16px;" class="group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
