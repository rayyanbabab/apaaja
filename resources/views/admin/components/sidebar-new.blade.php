    ...
    <div class="sidebar-container w-64 bg-white fixed top-0 left-0 z-40 border-r border-gray-100 flex flex-col h-full shadow-sm" data-role="{{ $sRole }}">
        ...
        @if($isOp)
            ...
            <div class="pt-4 flex flex-col gap-1">
                ...
                <a href="{{ route($rp . '.notifications.index') }}"
                   @if($isAct) data-active="true" @endif
                   class="flex items-center justify-between px-3 py-2 text-sm font-medium rounded-lg transition-all duration-150 border-l-[3px]
                          {{ $isAct ? $navActive : 'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                    <div class="flex items-center gap-3">
        ...
        @else
            ...
            <div class="pt-4 flex flex-col gap-1">
                ...
                <button @click="masterDataOpen = !masterDataOpen"
                        class="flex items-center justify-between w-full px-3 py-2 text-sm font-medium rounded-lg transition-all duration-150 border-l-[3px]
                    ...
                    <div class="flex items-center gap-3">
                        <svg style="width:18px;height:18px;flex-shrink:0;" class="{{ $isMasterChildActive ? $ic6 : 'text-gray-400' }}" :class="masterDataOpen ? '{{ $ic6 }}' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div x-show="masterDataOpen" x-collapse class="mt-1 space-y-0.5 pl-7">
                    ...
                    <a href="{{ route($rp . '.categories.index') }}"
                       @if($isAct) data-active="true" @endif
                    ...
                    <a href="{{ route($rp . '.suppliers.index') }}"
                       @if($isAct) data-active="true" @endif
                       class="flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-all duration-150 border-l-[3px]
                              {{ $isAct ? $navActiveM : 'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <div class="flex items-center gap-2.5">
                    ...
                    <a href="{{ route($rp . '.locations.index') }}"
                       @if($isAct) data-active="true" @endif
                       class="flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-all duration-150 border-l-[3px]
                              {{ $isAct ? $navActiveM : 'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <div class="flex items-center gap-2.5">
            ...
            <div class="pt-4 flex flex-col gap-1">
                ...
                <button @click="inventoryOpen = !inventoryOpen"
                    ...
                    <div class="flex items-center gap-3">
                        <svg style="width:18px;height:18px;flex-shrink:0;" class="{{ $isInvChildActive ? $ic6 : 'text-gray-400' }}" :class="inventoryOpen ? '{{ $ic6 }}' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div x-show="inventoryOpen" x-collapse class="mt-1 space-y-0.5 pl-7">
                    ...
                    <a href="{{ route($rp . '.inventory.index') }}"
                       @if($isAct) data-active="true" @endif
                       class="flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-all duration-150 border-l-[3px]
                              {{ $isAct ? $navActiveM : 'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <div class="flex items-center gap-2.5">
                    ...
                    <a href="{{ route($rp . '.incoming.index') }}"
                       @if($isAct) data-active="true" @endif
                       class="flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-all duration-150 border-l-[3px]
                              {{ $isAct ? $navActiveM : 'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <div class="flex items-center gap-2.5">
                    ...
                    <a href="{{ route($rp . '.outgoing.index') }}"
                       @if($isAct) data-active="true" @endif
                       class="flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-all duration-150 border-l-[3px]
                              {{ $isAct ? $navActiveM : 'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <div class="flex items-center gap-2.5">
                    ...
                    <a href="{{ route($rp . '.stock-opnames.index') }}"
                       @if($isAct) data-active="true" @endif
                       class="flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-all duration-150 border-l-[3px]
                              {{ $isAct ? $navActiveM : 'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <div class="flex items-center gap-2.5">
            ...
            <div class="pt-4 flex flex-col gap-1">
                ...
                <button @click="borrowingOpen = !borrowingOpen"
                    ...
                    <div class="flex items-center gap-3">
                        <svg style="width:18px;height:18px;flex-shrink:0;" class="{{ $isBorrowChildActive ? $ic6 : 'text-gray-400' }}" :class="borrowingOpen ? '{{ $ic6 }}' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div x-show="borrowingOpen" x-collapse class="mt-1 space-y-0.5 pl-7">
                    ...
                    <a href="{{ route($rp . '.borrowings.index') }}"
                       @if($isAct) data-active="true" @endif
                       class="flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-all duration-150 border-l-[3px]
                              {{ $isAct ? $navActiveM : 'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <div class="flex items-center gap-2.5">
                    ...
                    <a href="{{ route($rp . '.borrowing-requests.history') }}"
                       @if($isAct) data-active="true" @endif
                       class="flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-all duration-150 border-l-[3px]
                              {{ $isAct ? $navActiveM : 'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <div class="flex items-center gap-2.5">
                    ...
                    <a href="{{ route($rp . '.borrowings.history') }}"
                       @if($isAct) data-active="true" @endif
                       class="flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-all duration-150 border-l-[3px]
                              {{ $isAct ? $navActiveM : 'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <div class="flex items-center gap-2.5">
            ...
            <div class="pt-4 flex flex-col gap-1">
                ...
                <a href="{{ route($rp . '.procurement-requests.index') }}"
                   @if($isAct) data-active="true" @endif
                   class="flex items-center justify-between px-3 py-2 text-sm font-medium rounded-lg transition-all duration-150 border-l-[3px]
                          {{ $isAct ? $navActive : 'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                    <div class="flex items-center gap-3">
            ...
            <div class="pt-4 flex flex-col gap-1">
                ...
                <button @click="usersOpen = !usersOpen"
                    ...
                    <div class="flex items-center gap-3">
                        <svg style="width:18px;height:18px;flex-shrink:0;" class="{{ $isUsersChildActive ? $ic6 : 'text-gray-400' }}" :class="usersOpen ? '{{ $ic6 }}' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div x-show="usersOpen" x-collapse class="mt-1 space-y-0.5 pl-7">
                    ...
                    @endphp
                    <a href="{{ route($rp . '.content.listusers') }}"
                       @if($isAct) data-active="true" @endif
                       class="flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-all duration-150 border-l-[3px]
                              {{ $isAct ? $navActiveM : 'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <div class="flex items-center gap-2.5">
                    ...
                    <a href="{{ route($rp . '.content.createusers') }}"
                       @if($isAct) data-active="true" @endif
                       class="flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-all duration-150 border-l-[3px]
                              {{ $isAct ? $navActiveM : 'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <div class="flex items-center gap-2.5">
            ...
            <div class="pt-4 flex flex-col gap-1">
                ...
                <a href="{{ route($rp . '.insights.index') }}"
                   @if($isAct) data-active="true" @endif
                   class="flex items-center justify-between px-3 py-2 text-sm font-medium rounded-lg transition-all duration-150 border-l-[3px]
                          {{ $isAct ? $navActive : 'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                    <div class="flex items-center gap-3">
                ...
                <a href="{{ route($rp . '.activities.index') }}"
                   @if($isAct) data-active="true" @endif
                   class="flex items-center justify-between px-3 py-2 text-sm font-medium rounded-lg transition-all duration-150 border-l-[3px]
                          {{ $isAct ? $navActive : 'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                    <div class="flex items-center gap-3">
                ...
                <a href="{{ route($rp . '.settings.index') }}"
                   @if($isAct) data-active="true" @endif
                   class="flex items-center justify-between px-3 py-2 text-sm font-medium rounded-lg transition-all duration-150 border-l-[3px]
                          {{ $isAct ? $navActive : 'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                    <div class="flex items-center gap-3">
