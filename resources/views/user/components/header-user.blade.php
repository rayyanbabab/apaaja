<header class="flex h-16 items-center justify-between border-b border-gray-100 bg-white px-3 sm:px-6" style="position:sticky;top:0;z-index:30;min-width:0;">
    <!-- Left Side: User Info -->
                ...
                <div class="max-h-72 overflow-y-auto divide-y divide-gray-50">
                    <template x-if="notifications.length === 0">
                        <div class="flex flex-col items-center justify-center py-10 text-center">
                            ...
                            <p class="text-xs font-medium text-gray-500">Belum ada notifikasi</p>
                        </div>
                    </template>
